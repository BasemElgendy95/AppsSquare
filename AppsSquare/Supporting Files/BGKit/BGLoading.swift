...
class BGLoading: NSObject {
    ...
    static func showLoading(_ view:UIView){
        DispatchQueue.main.async{
            ...
            BGLoading.spinner = JHSpinnerView.showOnView(view, spinnerColor: UIColor.init(named: "ECAD3C"), overlay: .fullScreen, overlayColor: UIColor.black.withAlphaComponent(0.6), fullCycleTime: 4.0, text: "loading", textColor: UIColor.white)
